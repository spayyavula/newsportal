...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Editorial stories for the news portal';
    displayName: 'Article';
    pluralName: 'articles';
...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Writer profiles for the newsroom';
    displayName: 'Author';
    pluralName: 'authors';
    singularName: 'author';
  };
  ...
  attributes: {
    ...
    contactNote: Schema.Attribute.Text & Schema.Attribute.Required;
    coverageAreas: Schema.Attribute.JSON & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiFilterPresetFilterPreset
  extends Struct.CollectionTypeSchema {
  collectionName: 'filter_presets';
  info: {
    description: 'Reusable assistant filter bundle owned by a reader';
    displayName: 'Filter Preset';
    pluralName: 'filter-presets';
    singularName: 'filter-preset';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    deliveryStyle: Schema.Attribute.Enumeration<
      ['briefing', 'mixed', 'deep-dive']
    > &
      Schema.Attribute.DefaultTo<'mixed'>;
    description: Schema.Attribute.Text;
    excludeKeywords: Schema.Attribute.JSON;
    includeKeywords: Schema.Attribute.JSON;
    isDefault: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::filter-preset.filter-preset'
    > &
      Schema.Attribute.Private;
    maxReadMinutes: Schema.Attribute.Integer;
    minSourceCount: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<1>;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    onlyFeatured: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
...
export interface ApiNotificationRuleNotificationRule
  extends Struct.CollectionTypeSchema {
  collectionName: 'notification_rules';
  info: {
    description: 'Saved recurring briefing subscription for a reader';
  ...
  attributes: {
    ...
    channel: Schema.Attribute.Enumeration<['in-app', 'email']> &
      Schema.Attribute.DefaultTo<'in-app'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    deliveryHour: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<8>;
    frequency: Schema.Attribute.Enumeration<['daily', 'weekly', 'breaking']> &
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::notification-rule.notification-rule'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    owner: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    preset: Schema.Attribute.Relation<
      'manyToOne',
      'api::filter-preset.filter-preset'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiReaderProfileReaderProfile
  extends Struct.CollectionTypeSchema {
  collectionName: 'reader_profiles';
  info: {
    description: 'Saved assistant personalization profile for an authenticated reader';
    displayName: 'Reader Profile';
    pluralName: 'reader-profiles';
    singularName: 'reader-profile';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::reader-profile.reader-profile'
    > &
      Schema.Attribute.Private;
    maxReadMinutes: Schema.Attribute.Integer;
    minSourceCount: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<1>;
...
export interface ApiTopicTopic extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Coverage beats for the portal';
    displayName: 'Topic';
    pluralName: 'topics';
    singularName: 'topic';
  };
  ...
  attributes: {
    articles: Schema.Attribute.Relation<'oneToMany', 'api::article.article'>;
    cadence: Schema.Attribute.String & Schema.Attribute.Required;
    coverageFocus: Schema.Attribute.JSON & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text & Schema.Attribute.Required;
    editorialFocus: Schema.Attribute.Text & Schema.Attribute.Required;
    keyQuestions: Schema.Attribute.JSON & Schema.Attribute.Required;
    kicker: Schema.Attribute.String & Schema.Attribute.Required;
    landingIntro: Schema.Attribute.Text & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
